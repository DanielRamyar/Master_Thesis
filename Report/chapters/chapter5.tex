...
...
    ...
    \subsection{VHDL and Synthesis}
        ...
        Throughout this project we have carefully made sure that the C\scalerel*{\#}{X} simulation matched the generated VHDL testbench. The generated VHDL could then be given to vendor synthesis tools, which is used to implement the VHDL code on an FPGA.
