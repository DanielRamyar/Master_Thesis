...
__start:
    ...
    slti x18, x17, 7     # x18 = (x17 < 7)     ? 1:0 | 1 = (1 < 7) ? 1:0
    slti x19, x15, 1     # x19 = (x15 < 1)     ? 1:0 | 0 = (7 < 1) ? 1:0
    slti x20, x13, -5    # x20 = (x13 < -5)    ? 1:0 | 1 = (-2048 < -5) ? 1:0
    slti x21, x16, -2048 # x21 = (x16 < -2048) ? 1:0 | 0 = (-5 < -2048) ? 1:0
    slti x22, x14, -2048 # x22 = (x14 < -2048) ? 1:0 | 0 = (200 < -2048) ? 1:0
    slti x23, x13, 200   # x23 = (x13 < 200)   ? 1:0 | 1 = (-2048 < 200) ? 1:0