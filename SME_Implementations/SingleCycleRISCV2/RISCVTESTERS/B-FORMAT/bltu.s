...
__start:
    ...
    # Remember any negative number is larger than positive ones when converted to unsigned.
    bltu x14, x17, 24   # if(x14 < x17) PC += 24 | if(-200 < 199) PC += 24
    addi x17, x17, 1    # x17 += 1
    bltu x14, x17, 16   # if(x14 < x17) PC += 16 | if(-200 < 200) PC += 16
    addi x17, x17, -399 # x17 += -399
    bltu x14, x17, 16   # if(x14 < x17) PC += 16 | if(-200 < -199) PC += 16
    addi x17, x17, 1    # x17 += 1
    addi x17, x17, 304  # x17 += 304
    addi x17, x17, 1    # x17 += 1
    addi x17, x17, 1    # x17 += 1
    bltu x14, x17, 16   # if(x14 < x17) PC += 16 | if(-200 < -198) PC += 16
    addi x17, x17, 1    # x17 += 1
    addi x17, x17, 304  # x17 += 304
    addi x17, x17, 1    # x17 += 1
